...
- **Creator Dashboard** (`/dashboard/creator`) — creators edit their marketplace profile here, see **incoming booking requests**, and **accept or decline** them. Also lists active and past bookings.
