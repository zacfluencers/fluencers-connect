...
export const CREATOR_PROFILE_COLUMNS =
  "user_id, name, bio, niche, secondary_niches, instagram, tiktok, availability, price, ugc_rate, event_rate, broll_rate, gender, age, country, profile_image, instagram_followers, tiktok_followers, followers_synced_at, instagram_avatar, tiktok_avatar, engagement_rate";
